...
## Goal
Implement `Shop` according to Marketplace MASTER SPEC V3.0.

## Scope
shop lifecycle/staff scope
...
## V2.5 Mandatory
Shop activation/sale eligibility must consume Merchant ACTIVE state, category admission,
risk restrictions and deposit/platform policy. Do not treat Shop ACTIVE alone as saleable.
