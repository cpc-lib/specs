# TASK-003 — Merchant Onboarding

## Goal
Implement `Merchant Onboarding` according to Marketplace MASTER SPEC V3.0.

## Scope
merchant application/qualification/deposit
...
## V2.5 Mandatory
Implement MerchantApplication, MerchantVerificationProfile, settlement profile verification,
enterprise/C2C onboarding, category admission, deposit subledger and activation idempotency.
