...
## Goal
Implement `AfterSale` according to Marketplace MASTER SPEC V3.0.

## Scope
refund-only/return-refund/exchange/repair
...
## V2.3 Mandatory
AfterSaleCase owns entitlement decision. Implement ReturnOrder, ReverseShipment, ReturnInspection,
ExchangeOrder, RepairOrder, timeout clocks and evidence references. Do not embed payment provider calls in AfterSale aggregate.
