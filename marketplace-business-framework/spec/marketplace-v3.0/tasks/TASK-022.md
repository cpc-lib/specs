...
## Goal
Implement `Settlement` according to Marketplace MASTER SPEC V3.0.

## Scope
eligibility/batch/item/payable
...
## V2.1 Mandatory
Implement CommissionRule snapshot and SettlementEligibility consume-once model.
...
## V2.5 Mandatory
Settlement eligibility and payable creation must enforce explicit MerchantFundsHold scopes.
Partial holds must not freeze unrelated economic scope where policy permits.
