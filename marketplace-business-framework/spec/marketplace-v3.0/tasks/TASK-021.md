...
## Goal
Implement `Review` according to Marketplace MASTER SPEC V3.0.
...
## V2.6 Mandatory
Implement verified-purchase Review, AdditionalReview, SellerReviewReply,
risk + moderation gating, review summary projection and rebuild tests.
