# TASK-023 — Merchant Ledger

## Goal
Implement `Merchant Ledger` according to Marketplace MASTER SPEC V3.0.

## Scope
balance and marketplace accounting
...
## V2.1 Mandatory
Merchant balance changes use MerchantBalanceLedger; no direct repair UPDATE.
