...
## Goal
Implement `Dispute` according to Marketplace MASTER SPEC V3.0.
...
## V2.3 Mandatory
Implement append-only EvidenceRecord and immutable DecisionSnapshot.
Arbitration executes domain commands; it must not directly UPDATE payment/inventory/settlement tables.
