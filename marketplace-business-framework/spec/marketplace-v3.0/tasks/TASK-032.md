# TASK-032 — Seller Admin

## Goal
Implement `Seller Admin` according to Marketplace MASTER SPEC V3.0.
...
## V2.6 Mandatory
Seller Admin includes review reply, customer-service case handling and shop IM.
