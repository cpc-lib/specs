# TASK-034 — Buyer Frontend

## Goal
Implement `Buyer Frontend` according to Marketplace MASTER SPEC V3.0.

## Scope
buyer web/app API integration
...
## V2.6 Mandatory
Buyer frontend integrates search/facets/suggestions, recommendation tracking,
favorites/follows, review/additional review, notification preference, customer service and IM.
