...
## Goal
Implement `Payment` according to Marketplace MASTER SPEC V3.0.

## Scope
payment order/attempt/transaction
...
## V2.1 Mandatory
Implement TradePaymentAllocation, callback log, UNKNOWN query and duplicate callback tests.
