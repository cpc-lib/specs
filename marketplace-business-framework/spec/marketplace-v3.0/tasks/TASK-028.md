# TASK-028 — Recommendation

## Goal
Implement `Recommendation` according to Marketplace MASTER SPEC V3.0.

## Scope
behavior/read model integration
...
## V2.6 Mandatory
Implement Kafka behavior ingestion, candidate recall/rank pipeline,
model/policy versions, stable experiments/exposure and hard product/governance filters.
