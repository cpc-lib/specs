# TASK-017 — Receive Complete

## Goal
Implement `Receive Complete` according to Marketplace MASTER SPEC V3.0.

## Scope
buyer/auto receive/order completion
...
## V2.3 Mandatory
Separate CarrierDelivered / BuyerReceived / AutoReceived. Auto receive must lock and revalidate.
Rejected delivery must enter reverse path and must not blindly cancel Trade.
