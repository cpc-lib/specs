# TASK-038 — Production Hardening

## Goal
Implement `Production Hardening` according to Marketplace MASTER SPEC V3.0.

## Scope
chaos/performance/security/sharding
...
## V2.1 Mandatory
Validate ShardingSphere routing, contract validation, chaos and release gates.
...
## V2.5 Mandatory
Production hardening includes risk/governance audit, merchant isolation, funds-hold concurrency,
merchant-exit blockers, evidence retention and high-risk platform action dual-control tests.

## V2.6 Mandatory
Hardening includes ES outage/reindex, Kafka duplicate/lag, projection repair,
review anti-abuse, IM idempotency/moderation, notification provider failure and privacy/retention tests.
