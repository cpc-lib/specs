# TASK-031 — Notification

## Goal
Implement `Notification` according to Marketplace MASTER SPEC V3.0.
...
## V2.6 Mandatory
Implement NotificationPreference/Message/Delivery, channel adapters, quiet hours,
dedup, retry, receipt/bounce and category opt-out semantics.
