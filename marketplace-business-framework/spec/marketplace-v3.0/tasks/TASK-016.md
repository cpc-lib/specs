...
## Goal
Implement `Logistics` according to Marketplace MASTER SPEC V3.0.

## Scope
carrier adapter/tracking
...
## V2.3 Mandatory
Implement LogisticsProviderAdapter, normalized append-only tracking events, out-of-order protection,
delivery exceptions, rejection/return-to-sender semantics and reverse shipment tracking.
