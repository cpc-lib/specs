...
## Goal
Implement `Payout` according to Marketplace MASTER SPEC V3.0.

## Scope
merchant payout/UNKNOWN
...
## V2.5 Mandatory
Payout must check active funds holds before provider request.
HOLD/REVIEW decisions create explicit facts; provider UNKNOWN semantics remain unchanged.
