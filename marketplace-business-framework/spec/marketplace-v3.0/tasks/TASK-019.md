...
## Goal
Implement `Refund` according to Marketplace MASTER SPEC V3.0.

## Scope
quota reservation/provider/refund facts
...
## V2.1 Mandatory
Implement refund quota reservation + refund transaction. UNKNOWN keeps quota reserved.
...
## V2.3 Mandatory
RETURN_REFUND starts provider refund only after return/inspection/policy says refundable.
Refund still uses V2.2 quota reservation and reverse-clearing rules. Partial accepted quantity must cap refund scope.
