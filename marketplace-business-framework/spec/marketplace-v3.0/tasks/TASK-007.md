...
## Goal
Implement `Pricing` according to Marketplace MASTER SPEC V3.0.

## Scope
price rules/snapshots
...
## V2.4 Mandatory
Implement PriceBook/PriceBookItem, PriceSelectionPolicy, PricingSnapshot,
regional/channel/member pricing and price-change approval/effective-date workflow.
