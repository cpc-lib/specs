...
## Goal
Implement `Flash Sale` according to Marketplace MASTER SPEC V3.0.

## Scope
hot inventory/rate limit/queue
...
## V2.4 Mandatory
Flash sale must separate campaign quota from warehouse InventoryReservation.
Implement Redis/Lua front gate, durable flash reservation, purchase limit, queue, compensation and reconciliation.
