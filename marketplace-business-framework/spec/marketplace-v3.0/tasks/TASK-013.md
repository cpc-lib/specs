# TASK-013 — Order Create Saga

## Goal
Implement `Order Create Saga` according to Marketplace MASTER SPEC V3.0.

## Scope
inventory/coupon/promotion compensation
...
## V2.1 Mandatory
Implement SAGA-COMPENSATION-MATRIX CreateTrade exactly; persist trade idempotency and discount allocation.
...
## V2.4 Mandatory
CreateTrade Saga includes promotion budget/quota and coupon locks with idempotent compensation.
Gift/bundle component inventory must use normal InventoryReservation.
