...
## Goal
Implement `Checkout` according to Marketplace MASTER SPEC V3.0.

## Scope
checkout session/token/revalidation
...
## V2.4 Mandatory
Checkout must call deterministic Pricing + Promotion evaluation and freeze all referenced versions/hashes.
SubmitTrade must recompute mutable facts and reject stale/incompatible snapshots.
