# TASK-006 — Product SPU SKU Offer

## Goal
Implement `Product SPU SKU Offer` according to Marketplace MASTER SPEC V3.0.

## Scope
product publishing/snapshots
...
## V2.4 Mandatory
Implement immutable SPUVersion/SKUVersion/OfferVersion, normalized SKU combination uniqueness,
brand authorization/compliance validation and Offer publish request pipeline.

## V2.5 Mandatory
Offer publish must revalidate merchant category admission, governance policy,
risk decision and existing V2.4 brand/compliance requirements.
