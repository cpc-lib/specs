...
## Goal
Implement `Search` according to Marketplace MASTER SPEC V3.0.
...
## V2.6 Mandatory
Implement versioned Search projection, mapping/index aliases, search_after,
facets, query planning, synonym/correction, rank policy and reindex/repair tooling.
