...
## Goal
Implement `Risk` according to Marketplace MASTER SPEC V3.0.

## Scope
buyer/seller risk decision
...
## V2.5 Mandatory
Implement RiskRuleSet, RiskFeatureSnapshot, RiskDecision, RiskCase and scenario-specific
PASS/REVIEW/REJECT/CHALLENGE/HOLD output. Risk must not directly mutate business domains.

## V2.6 Mandatory
Risk integrates review authenticity and recommendation/search abuse features without owning Review/Search state.
