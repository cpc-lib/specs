# TASK-015 — Fulfillment

## Goal
Implement `Fulfillment` according to Marketplace MASTER SPEC V3.0.

## Scope
fulfillment/package/shipment
...
## V2.3 Mandatory
Implement FulfillmentOrder/FulfillmentOrderItem, route snapshot, Package/PackageItem, Shipment/TrackingEvent,
partial shipment quantity invariants, idempotent package shipment and delivery confirmation.
