...
## Responsibility
Notification preferences, templates, messages and delivery facts.
...
- `spec/marketplace-v3.0/02-domain/notification/`
- `spec/marketplace-v3.0/03-database/flyway/notification/`
