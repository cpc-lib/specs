...
## Responsibility
Customer service cases and buyer-seller communication context.
...
- `spec/marketplace-v3.0/02-domain/customer-service/`
- `spec/marketplace-v3.0/04-openapi/customer-experience.yaml`
- `spec/marketplace-v3.0/03-database/flyway/customer-service/`
