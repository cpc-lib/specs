# SPEC 18 — Distributed Idempotency & Consistency Framework

## V1.0 Frozen Baseline

HTTP Idempotency-Key + Canonical Hash + PROCESSING/SUCCESS/FAILED/Replay。
MQ 消费 eventId+consumer 唯一、业务版本防乱序。
Outbox + Publisher Confirm + Retry + DLQ；Job 依靠业务状态机/CAS 幂等。
---
