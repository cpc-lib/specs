...
## Business Goal
Maintenance/renovation/work orders, move-in/move-out, damage charges, schedule impact and closure.

## Scope / Bounded Context
`alop-asset/alop-agreement`
...
- MOVE_IN initial water/electric readings.
- MOVE_OUT final readings and utility settlement gate before Agreement CLOSED.
- Parking handover / vehicle binding lifecycle.
