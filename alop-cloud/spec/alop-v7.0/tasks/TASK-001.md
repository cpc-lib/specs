...
## Business Goal
Parent BOM, common Result/Error/Money/TimeRange/TenantContext abstraction, trace, Snowflake, Flyway/Testcontainers base, gateway security baseline.

## Scope / Bounded Context
`alop-bom/common/gateway`
