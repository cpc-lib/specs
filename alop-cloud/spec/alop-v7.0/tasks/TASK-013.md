...
## Business Goal
Billing rules, 1-12 month cycle, proration, free period, escalation, discounts, deposits/fees, water/electricity tariff billing, property management fee, parking rent, calculation trace, BillIssued.
...
## V6.3 Mandatory Cases
- WATER/ELECTRICITY from VERIFIED meter reading only.
- Tiered tariff boundary/rounding.
- PROPERTY_MANAGEMENT_FEE by chargeable area snapshot.
- PARKING_RENT independent and bundled agreement items.
- Corrected billed reading creates adjustment, never history mutation.
