...
## Business Goal
Persistent sign process, idempotent CommitReservation, Occupancy creation, compensation/recovery tests.

## Scope / Bounded Context
`alop-agreement + alop-asset`
