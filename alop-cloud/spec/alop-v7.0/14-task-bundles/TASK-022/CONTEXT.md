# TASK-022 Codegen Context Bundle

Title: TASK-022 — Tenant Dedicated DB Migration
...
- `01-architecture/adr/ADR-009-tenant-routing.md`
...
- `tasks/TASK-022.md`
- `02-domain/tenant/DOMAIN-SPEC.md`
